...
if not CHAT_ID:
    print("TELEGRAM_CHAT_ID not set; skipping telegram notification.")
    raise SystemExit(0)
...
if IS_STABLE:
    text += f"\nhttps://github.com/vulcanen/FlClash/releases/tag/{TAG}\n"
else:
    text += f"\nhttps://github.com/vulcanen/FlClash/actions/runs/{RUN_ID}\n"
